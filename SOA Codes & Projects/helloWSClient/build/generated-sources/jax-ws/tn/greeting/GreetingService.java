 ...
 * 
 */
@WebServiceClient(name = "greetingService", targetNamespace = "http://greeting.tn", wsdlLocation = "http://localhost:32533/HelloWS/greetingService?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:32533/HelloWS/greetingService?WSDL");
     ...
     * 
     * @return
     *     returns GreetingPortType
     */
    @WebEndpoint(name = "greetingPort")
    public GreetingPortType getGreetingPort() {
        return super.getPort(new QName("http://greeting.tn", "greetingPort"), GreetingPortType.class);
    }
     ...
     */
    @WebEndpoint(name = "greetingPort")
    public GreetingPortType getGreetingPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://greeting.tn", "greetingPort"), GreetingPortType.class, features);
    }
