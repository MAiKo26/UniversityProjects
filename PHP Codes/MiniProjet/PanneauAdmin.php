<?php session_start();
            ...
            if (($_SESSION["Role"])!="Admin")
            {
                  ...
                  header("Location: http://localhost/Brackets/MiniProjet/index.php") ;
                  exit();
    ...
    <a class="navbar-brand" href="index.php">   &nbsp;&nbsp; <img src="img/maikologo.png" width="150" height="20"></a> &nbsp;&nbsp;&nbsp;&nbsp;
     ...
     <form class="d-flex">
      ...
      <button class="btn btn-outline-success" type="submit">Search</button>
        ...
        <br><br>
    <center><h1>Panneau Administrateur :</h1> </center>
            <center><h2> Gérer Les Produits : </h2></center>
            <center>  <a href="AjouterProduit.php"> <button  ><h4>Ajouter Produit</h4></button> </a><a href="SupprimerProduit.php"><button ><h4>Supprimer Produit</h4></button> </a> <a href="ConsulterProduit.php"> <button><h4>Consulter la Liste des Produits</h4></button> </a> </center>
  

     <br>
            <br>

            <center><a href="ConsulterClient.php"><button ><h4>Consulter La Liste Des Clients</h4></button></a></center>
            <br>

            <br>

                            <center><a href="ConsulterCommande.php"><button ><h4>Consulter La Liste des Commandes</h4></button></a></center>
