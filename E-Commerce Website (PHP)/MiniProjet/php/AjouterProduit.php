...
<br>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
          <h1><center>Donner le Produit a Ajouter</center></h1>
        <table class="table">
            <form method="post" action="AP.php" >
            <tr> <td> ID Produit  </td> <td> <input type='text' name="IDP"> </td>  </tr>
               <tr> <td> Désignation </td> <td> <input type='text' name="DES"> </td> </tr>
               <tr> <td> Prix </td> <td> <input type='text' name="PRX"> </td> </tr>
               <tr> <td> Quantité </td> <td> <input type='text' name="QTE"> </td> </tr>
               <tr> <td> Catégorie </td> <td> <input type='text' name="CAT"> </td> </tr>
               <tr> <td> Marque </td> <td> <input type='text' name="MRQ"> </td> </tr>
               <tr> <td> Fournisseur </td> <td> <input type='text' name="FOR"> </td> </tr>
               <tr> <td> <button type='submit' > Ajouter Produit </button> <button type='reset'>Annuler </button> </td> </tr>
